  ...
  return (
    <div className="container pt-10">
      <h1 className="text-center text-3xl">
        پکیج های مهم استفاده شده در پروژه
      </h1>
      ...
      <div className="my-8">
        <div className="mockup-code space-y-2">
          ...
          <Row packageName="daisyui">
            کامپوننت لایبرری از Tailwindcss برای Ui
          </Row>
          <Row packageName="zustand">
            برای مدیریت استیت های کلاینت (استفاده از قابلیت persist برای ذخیره و
            آپدیت خودکار داده ها در localeStorage )
          </Row>
          <Row packageName="swr">
          ...
          <Row packageName="jsonwebtoken @types/jsonwebtoken">
            برای Generate و Verify کردن توکن های JWT (Access Token و Refresh
            Token)
          </Row>
          <Row packageName="react-jwt">
            برای چک کردن Expire شدن توکن های Access و Refresh
          </Row>
          <Row packageName="bcryptjs @types/bcryptjs">
            برای Hash کردن Password کاربر
          </Row>
          <Row packageName="framer-motion">برای Transition عوض شدن صفحه</Row>
          <Row packageName="react-multi-date-picker">
            تقویم استفاده شده در پروژه
          </Row>
          ...
          <Row packageName="sweetalert2">
            Alert برای Confirm کردن برخی درخواست های کاربر در Ui
          </Row>
